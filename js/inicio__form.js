...
function FbotonOn() {
    ...
    switch (iteracion) {
        ...
        break;
        case 1:
            document.getElementById("botonOn").innerHTML= "<p>Bienvenid@.</p><span>Este es un espacio </span><span style='color: gold;'>CL4N_D35T1NO.</span>";
        break;
        case 2:
            texto.innerText = "Si quieres acabar con la corrupción y los\n abusos, te puede interesar lo que estamos\n haciendo.";
        break;
        case 3:
